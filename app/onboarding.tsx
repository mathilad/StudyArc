...
const BUILD_STAGES=[
  ...
  "Protecting breaks and daily routine",
...
export default function OnboardingScreen(){
  ...
  if(generating)return <View style={s.buildRoot}>
    ...
    <View style={s.buildCard}>
      ...
      <Text style={s.buildText}>Study Arc is fitting your subjects, classes and real daily routine together.</Text>
