...
export default function MoreScreen(){
 ...
 const logout=async()=>{if(busy)return;setBusy(true);const result=await signOut();setBusy(false);if(result.error)Alert.alert("Could not sign out",result.error);else router.replace("/login")};
