 ...
 return <View style={s.root}><LinearGradient colors={["#2D1742","#111426","#080D14"]} style={StyleSheet.absoluteFill}/>
  ...
  <ScrollView contentContainerStyle={s.content} showsVerticalScrollIndicator={false}>
   ...
   <View style={s.learningCard}>
    <View style={s.learningHead}><View style={s.learningIcon}><Ionicons name="git-compare-outline" size={22} color="#D6B8F5"/></View><View style={{flex:1}}><Text style={s.learningTitle}>Syllabus coverage</Text><Text style={s.learningSub}>Class teaching and your own coverage are shown together here, while StudyArc still tracks their sources separately for planning.</Text></View></View>
    <View style={s.learningRows}>
     <View style={s.learningRow}><View style={[s.learningRowIcon,{backgroundColor:"#C5A2F118"}]}><Ionicons name="school-outline" size={18} color="#C5A2F1"/></View><View style={{flex:1}}><Text style={s.learningRowLabel}>Class taught</Text><Text style={s.learningRowMeta}>{classWeeklyPace} new lessons/week</Text></View><Text style={s.learningValue}>{classTopics.size}/{totalTopics}</Text></View>
     <View style={s.learningDivider}/>
     <View style={s.learningRow}><View style={[s.learningRowIcon,{backgroundColor:"#7FCBA418"}]}><Ionicons name="person-outline" size={18} color="#7FCBA4"/></View><View style={{flex:1}}><Text style={s.learningRowLabel}>Self covered</Text><Text style={s.learningRowMeta}>Independent coverage</Text></View><Text style={s.learningValue}>{manualTopics.size}/{totalTopics}</Text></View>
    </View>
   </View>
