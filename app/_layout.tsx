...
export default function RootLayout() {
  ...
  return <View style={{ flex: 1, backgroundColor: "#080D14" }}>
    <AuthProvider><AppConfigProvider><OfflineProvider><StudentProvider><ClassLearningProvider><PlanningProvider><ScheduleAdjustmentsProvider><PhaseProvider><StudyProvider><SocialProvider>
      <StatusBar hidden />
