...
export default function MoreScreen(){
 ...
 const logout=()=>{if(busy)return;setBusy(true);router.replace("/login");signOut().then(result=>{if(result.error)console.warn("Supabase local sign-out cleanup failed:",result.error)}).finally(()=>setBusy(false))};
