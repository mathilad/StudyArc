...
export default function PaperWrittenDateGate({ sourceClassId, subjectName }: { sourceClassId: string | null; subjectName: string | null }) {
  ...
  const selectedClass=paperClasses.find(c=>c.id===sourceClassId)??paperClasses[0]??null;
